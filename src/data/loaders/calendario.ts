...
const PERIODOS_PADRAO: PeriodoCalendario[] = [
  {
    ...
    competicoes_ativas: ["paulistao_a1", "carioca_a", "mineiro_1", "gauchao_1", "brasileirao_serie_a", "brasileirao_serie_b"],
  },
  {
    periodo: "fev",
    competicoes_ativas: ["paulistao_a1", "carioca_a", "mineiro_1", "gauchao_1", "copa_do_brasil", "brasileirao_serie_a", "brasileirao_serie_b"],
  },
  {
    periodo: "mar",
    competicoes_ativas: ["paulistao_a1", "carioca_a", "mineiro_1", "gauchao_1", "copa_do_brasil", "libertadores", "sulamericana"],
  },
  {
    periodo: "abr",
    competicoes_ativas: ["paulistao_a1", "carioca_a", "mineiro_1", "gauchao_1", "copa_do_brasil", "libertadores", "sulamericana"],
